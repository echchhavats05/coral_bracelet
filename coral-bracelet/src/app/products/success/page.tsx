...
export default function SuccessPage() {
  ...
  const handleImageSelect = (image: string) => {
    ...
    if (image.includes("success1")) {
      setSelectedId(301);
    } else if (image.includes("success2")) {
      setSelectedId(302);
    } else if (image.includes("success3")) {
      setSelectedId(303);
    }
  };
    ...
    <main className="max-w-7xl mx-auto px-6 py-24">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        ...
        <ProductGallery
          images={[
            "/images/success/success1.jpg",
            "/images/success/success2.jpg",
            "/images/success/success3.jpg",
          ]}
        ...
        <div>
          ...
          <p className="mt-8 text-gray-600 text-lg leading-relaxed">
            A symbol of focus, discipline, growth and
            achievement.
          </p>
          ...
          {/* WHATSAPP */}
          <a
            href="https://wa.me/YOURNUMBER?text=Hi%20I%20want%20to%20order%20Success%20Bracelet"
            target="_blank"
